...
export default function TermsPage() {
  return (
    <LegalArticle title="Terms of Service" effectiveDate={EFFECTIVE_DATE}>
      <p>
        ...
        &quot;you,&quot; or &quot;your&quot;) and <strong>Namalabs under PT Cipta Cita Indonesia</strong> (&quot;Memoli,&quot;
      ...
      <p>
        <strong>1.1 Memoli&apos;s Ecosystem and Functionality</strong> Memoli operates as a digital household management ecosystem
      ...
      <p>
        <strong>1.2 User Contributions</strong> Users interact with the Service by voluntarily scanning physical product labels,
      ...
      <p>
        <strong>1.3 Third-Party Integration</strong> The Service integrates with external databases, including the public e-BPOM
        database, to provide real-time product verification. We also integrate with third-party authentication
        services (Apple Sign-In) and e-commerce platforms for replenishment features. <strong>Namalabs under PT Cipta Cita
        Indonesia</strong> does not control these third-party systems and is not responsible for their operational uptime
        or data accuracy.
      </p>
      <p>
        <strong>1.4 Subscriptions (Freemium and Go Unlimited)</strong> Memoli operates on a Freemium Business Model. Basic features
      ...
      <p>
        <strong>1.5 Billing and Renewals</strong> Premium subscriptions are billed automatically on a recurring basis (monthly or
        annually) through your designated Apple App Store account. Your subscription will automatically renew
        unless auto-renew is turned off at least 24 hours before the end of the current billing period. <strong>Namalabs
        under PT Cipta Cita Indonesia</strong> reserves the right to modify subscription pricing with reasonable prior
        notice provided within the app.
      </p>

      <h2>2. Eligibility and Account Registration</h2>
      <p>
        <strong>2.1 Minimum Age and Legal Capacity</strong> You must be at least 17 years of age, or the age of legal majority in
        your jurisdiction, to create an account and use the Service. By registering, you represent and warrant
        that you possess the legal capacity to enter into a binding contract with <strong>Namalabs under PT Cipta Cita
        Indonesia</strong>.
      </p>
      <p>
        <strong>2.2 Account Creation, Security, and Authentication</strong> To utilize the Service, you must register using a valid
        Apple ID. You are strictly responsible for maintaining the confidentiality of your authentication
        credentials. <strong>Namalabs under PT Cipta Cita Indonesia</strong> utilizes secure authentication protocols but cannot be
        held liable for unauthorized access resulting from your failure to secure your device or credentials.
      </p>
      <p>
        <strong>2.3 Responsibility for Activity</strong> You are entirely responsible for all activities, data entries, and
      ...
      <p>
        <strong>3.1 User-Provided Information</strong> You retain all ownership rights to the personal images (e.g., photos of your
        pantry or receipts) you upload. By providing this information, you grant <strong>Namalabs under PT Cipta Cita
        Indonesia</strong> a non-exclusive, royalty-free license to process, store, and analyze this data strictly to
        deliver the Service&apos;s core functionalities.
      </p>
      <p>
        <strong>3.2 Third-Party Information and Information Accuracy</strong> Memoli aggregates data from public regulatory
        registries and open-source product databases. While we strive for high accuracy, <strong>Namalabs under PT Cipta
        Cita Indonesia</strong> does not independently verify, nor do we guarantee, the completeness, currentness, or
        absolute accuracy of third-party ingredient or regulatory data.
      </p>
      <p>
        <strong>3.3 The &quot;Safety Net&quot; Limitation (CRITICAL)</strong> Memoli is intended to function as an organizational
      ...
      <p>
        <strong>3.4 Regulatory Compliance (BPOM/SNI/INCI)</strong> The Service may highlight product statuses based on public
        ...
        constitute a safety guarantee or an endorsement by <strong>Namalabs under PT Cipta Cita Indonesia</strong>.
      </p>

      <h2>4. Prohibited Conduct</h2>
  <p><strong>4.1 Misuse of Service</strong></p>
      <p>
        ...
        illegal, uncertified, or illicit substances. <strong>Namalabs under PT Cipta Cita Indonesia</strong> reserves the right to
  ...
  <p><strong>5.1 Account Termination</strong></p>
      <p>
        You may terminate your account at any time via the in-app settings. <strong>Namalabs under PT Cipta Cita Indonesia</strong>
  ...
  <p><strong>5.2 Changes to Service</strong></p>
      <p>
      ...
      <p>
        <strong>6.1 Data Sovereignty and B2B Analytics</strong> Your privacy is foundational to our operations. <strong>Namalabs under PT
        Cipta Cita Indonesia</strong> collects and processes your data in accordance with our Privacy Policy. We maintain
      ...
      <p>
        <strong>6.2 Cross-Border Data Transfer</strong> While our primary operations and target markets reside within Indonesia,
      ...
      <p>
        <strong>7.1 AI and Automated Processing Disclosure</strong> Memoli heavily relies on automated processing technologies,
        ...
        produce hallucinations, misread expiration dates, or incorrectly categorize ingredients. <strong>Namalabs under PT
        Cipta Cita Indonesia</strong> disclaims any liability for errors generated by our automated systems. You remain
        solely responsible for manually verifying critical safety dates and ingredient lists.
      </p>

      <h2>8. Intellectual Property Rights</h2>
      <p>
        <strong>8.1 Our Rights</strong> All intellectual property rights, including but not limited to copyrights, patents,
        database rights, and source code associated with the Memoli application, are the exclusive legal property
        of <strong>Namalabs under PT Cipta Cita Indonesia</strong>. No rights or licenses are granted to you except the limited,
        revocable right to use the Service in accordance with these Terms. <strong>8.2 Your Information and Content</strong> You
        retain full ownership of the raw data and images you input into the Service. <strong>8.3 Trademarks</strong>
        &quot;Memoli,&quot; &quot;Lascan,&quot; and all associated logos, branding, and service marks are registered
        or unregistered trademarks of <strong>Namalabs under PT Cipta Cita Indonesia</strong>. You may not utilize these trademarks
        without our prior written consent.
      </p>

      <h2>9. Third-Party Services &amp; Links</h2>
      <p>
        <strong>9.1 Third-Party Services and Information</strong> The Service incorporates links to external domains, regulatory
      ...
      <p>
        <strong>9.2 Smart Replenishment and Affiliate Disclosure</strong> Memoli features a &quot;Smart Replenishment System&quot;
        that provides low-stock alerts accompanied by direct checkout links to third-party marketplaces (e.g.,
        Tokopedia, Shopee, Alfagift). You acknowledge that these are affiliate links. <strong>Namalabs under PT Cipta Cita
        Indonesia</strong> may earn an affiliate commission if you finalize a purchase through these links.
      </p>
      <p>
        <strong>9.3 No Endorsement</strong> The presence of affiliate links or safe alternatives within the app does not constitute
        a formal endorsement of the third-party merchant, product quality, or delivery fulfillment by <strong>Namalabs
        under PT Cipta Cita Indonesia</strong>. Any transaction you initiate is strictly between you and the respective
        third-party merchant.
      </p>

      <h2>10. Disclaimers and Limitation of Liability</h2>
      <p>
        <strong>10.1 No Warranty</strong> The Service is provided strictly on an &quot;AS IS&quot; and &quot;AS AVAILABLE&quot;
        basis. <strong>Namalabs under PT Cipta Cita Indonesia</strong> explicitly disclaims all warranties, whether express,
        implied, or statutory, including but not limited to warranties of merchantability, fitness for a
        particular purpose, and non-infringement.
      </p>
      <p>
        <strong>10.2 Limitation of Liability</strong> To the maximum extent permitted by applicable law, in no event shall <strong>Namalabs
        under PT Cipta Cita Indonesia</strong>, its founders, directors, or employees be liable for any indirect,
      ...
      <p>
        <strong>10.3 User Assumption of Risk</strong> You assume all risks associated with consuming or utilizing products tracked
      ...
      <p>
        <strong>10.4 Beta Testing Liability</strong> Certain features, particularly early-stage AI implementations or Closed Beta
        launches, are experimental. By participating in beta testing, you acknowledge that the Service may
        contain significant bugs or flaws, and <strong>Namalabs under PT Cipta Cita Indonesia</strong> shall bear zero liability
        for any data loss or inaccurate safety tracking during these phases.
      </p>

      <h2>11. Indemnification</h2>
      <p>
        You agree to defend, indemnify, and hold harmless <strong>Namalabs under PT Cipta Cita Indonesia</strong>, its affiliates,
  ...
  <p><strong>12.2 Dispute Resolution</strong></p>
      <p>
        ...
        competent district courts within Indonesia where <strong>Namalabs under PT Cipta Cita Indonesia</strong> is legally
        registered.
      </p>
  <p><strong>12.3 Force Majeure</strong></p>
      <p>
        <strong>Namalabs under PT Cipta Cita Indonesia</strong> shall not be liable for any failure or delay in performance under
