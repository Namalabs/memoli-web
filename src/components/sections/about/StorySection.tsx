      ...
      <div className="max-w-[1280px] mx-auto px-6 py-12 md:px-10 md:py-16 lg:px-16 lg:py-32">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8 lg:gap-12">
          ...
          <div ref={textRef} className="flex-1">
            <h2 className="text-memoli-accent font-bold text-2xl md:text-[56px]">
              Our Story
            </h2>
            <p className="mt-2 md:mt-2 text-memoli-dark font-medium text-base md:text-2xl">
              Born at the Apple Developer Academy Bali.
            </p>

            <p className="mt-4 md:mt-4 lg:mt-6 text-memoli-dark font-medium leading-relaxed text-base md:text-2xl">
              Memoli tracks shelf-life and verifies ingredients, serving as a
              mindful companion for your family&apos;s daily essentials.
            </p>

            <p className="mt-3 md:mt-3 lg:mt-4 text-memoli-dark font-medium leading-relaxed text-base md:text-2xl">
